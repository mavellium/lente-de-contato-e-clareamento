...
const WhiteningDetails = () => {
    ...
    return (
        <section ref={sectionRef} className="common-padding bg-transparent py-20 px-6 md:px-12 lg:px-10">
            <div className="mx-auto relative max-w-[1520px]">
                <h1 className="sm:text-[32px] text-[24px] text-[#B9C2D8] font-bold mb-10">
                    Veja os detalhes do clareamento
                </h1>
...
export default WhiteningDetails;